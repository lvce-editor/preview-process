...
await cp(
  join(root, 'node_modules', '@lvce-editor', 'preview-injected-code', 'dist', 'previewInjectedCodeMain.js'),
...
const getWsVersion = async () => {
  const packageJson = await readJson(join(root, 'node_modules', 'ws', 'package.json'))
